...
namespace fuzz {
   ...
   */
  int partial_ratio(const std::string &s1, const std::string &s2);
  int partial_ratio(const std::wstring &s1, const std::wstring &s2);
   ...
   */
  int token_sort_ratio(const std::string &s1, const std::string &s2, bool full_process = true);
  int token_sort_partial_ratio(const std::string &s1, const std::string &s2, bool full_process = true);
   ...
   */
  int token_set_ratio(const std::string &s1, const std::string &s2, bool full_process = true);

  /*
   * Returns the ratio of the most similar substring as a number
   * between 0 and 100 but sorting the token before comparing.
   */
  int partial_token_set_ratio(const std::string &s1, const std::string &s2, bool full_process = true);
